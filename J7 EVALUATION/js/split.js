document.addEventListener('DOMContentLoaded', async () => {
  ...
  // N-03 : l'organisateur est compté dans le calcul mais pas toujours dans le détail affiché
  const divisorSplit = inscrits > 0 ? inscrits + 1 : 0
  const montantParPersonne = divisorSplit > 0 ? outing.totalPrice / divisorSplit : 0
